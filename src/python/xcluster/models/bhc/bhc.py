...
class bhc(object):
    ...
    def __init__(self, data, data_model, point_ids=None, cluster_ids=None, crp_alpha=1.0,
                 verbose=False):
        """
        ...
        nodes = dict((i, Node(np.array([x]), data_model, crp_alpha,
                              indexes=i, point_id=point_ids[i] if point_ids else None,
...
class Node(object):
    ...
    def __init__(self, data, data_model, crp_alpha=1.0, log_dk=None,
                 ...
                 left_child=None, right_child=None, indexes=None, point_id=None, cluster_id=None):
        """
        Parameters
        ----------
        data : numpy.ndarray
