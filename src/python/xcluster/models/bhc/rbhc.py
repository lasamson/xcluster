...
class rbhc(object):
    ...
    def __init__(self, data, data_model, crp_alpha=1.0, point_ids=None, cluster_ids=None, sub_size=50,
                 verbose=False):
...
class rbhc_Node(object):
    ...
    def __init__(self, data, data_model, crp_alpha=1.0, prev_wk=1.,
                 node_level=0, level_index=0, point_id=None, cluster_id=None):
        ...
        self.id = self.point_id if point_id else str(uuid.uuid4())
        ...
        if (parent_node.prev_wk*parent_node.nk) < 1E-3:
            ...
            if parent_node.nk > sub_size:
                ...
                parent_node.true_bhc = bhc(parent_node.data,
                                           ...
                                           crp_alpha=parent_node.crp_alpha)
    ...
    def subsample_bhc(self, sub_size):
        ...
        self.sub_bhc = bhc(sub_data, self.data_model, crp_alpha=self.crp_alpha)
